...
INSURANCE_COMPANIES = {
    "AXA": {
        "id": "AXA",
        "name": "AXA Egypt Insurance",
        "country": "Egypt",
        "network": "AXA National Network",
        "contact": "16363"
    },
    "GIG": {
        "id": "GIG",
        "name": "GIG Egypt (Arab Misr Insurance Group)",
        "country": "Egypt",
        "network": "GIG Premium Network",
        "contact": "19792"
    },
    "MISR": {
        "id": "MISR",
...
POLICIES = {
    "502277005": {
        ...
        "company_id": "AXA",
        "company_name": "AXA Egypt Insurance",
        "policy_holder": "Nile Media International Production",
        ...
        "classes": {
            "VIP": {
                ...
                "inpatient": True,
                "outpatient": True,
                "outpatient_deductible": "20% up to EGP 50",
                ...
                "covered_services": {
                    ...
                    "Maternity": {"covered": True, "limit": "EGP 30,000", "notes": ""},
                    "Dental (Corrective)": {"covered": True, "limit": "EGP 3,000", "notes": "0% deductible"},
                    "Dental (Emergency)": {"covered": True, "limit": "EGP 2,000", "notes": "20% up to EGP 800"},
                    "Dental (General)": {"covered": False, "limit": "Not Covered", "notes": ""},
                    "Optical": {"covered": True, "limit": "EGP 2,250", "notes": "Frame EGP 800 sub-limit"},
                    "Vaccination": {"covered": True, "limit": "Annual Limit", "notes": ""},
                    "Psychiatric": {"covered": True, "limit": "EGP 50,000", "notes": ""},
                    "Dialysis": {"covered": True, "limit": "EGP 180,000", "notes": ""},
                    "Hearing Aids": {"covered": True, "limit": "EGP 6,000", "notes": ""},
                    "Kidney Transplant": {"covered": True, "limit": "EGP 250,000", "notes": ""},
                    "Bone Marrow Transplant": {"covered": False, "limit": "Not Covered", "notes": ""},
                    "Obesity Surgery": {"covered": True, "limit": "EGP 20,000", "notes": "BMI > 35 required"},
                    "ABA Therapy": {"covered": True, "limit": "EGP 50,000", "notes": "Per CHI regulations"},
                    "Cancer Treatment": {"covered": True, "limit": "Annual Limit", "notes": "Includes wig EGP 1,000"},
                    "Routine Checkup": {"covered": False, "limit": "Not Covered", "notes": ""},
                    "Screening": {"covered": True, "limit": "Annual Limit", "notes": ""},
                    "Birth Control": {"covered": True, "limit": "EGP 1,500", "notes": ""},
                    "Circumcision": {"covered": True, "limit": "EGP 500", "notes": ""},
                    "Neonatal Care": {"covered": True, "limit": "Annual Limit", "notes": ""},
                },
                "special_instructions": "Autism/ABA: EGP 50,000 (CHI). Down Syndrome: Covered. Cancer + wig EGP 1,000. Supplements/Probiotics: Covered. Glucometers: Covered. Joint Replacement: 3 members. Vision Correction: 5 members."
            },
            "A": {
                "annual_limit": 1875000,
                ...
                "pre_auth_limit": 2500,
                "pre_auth_notes": "Pre-authorization required for services exceeding EGP 2,500. Medication limit equals approval limit.",
                "covered_services": {
                    "MRI Scan": {"covered": True, "limit": "Annual Limit", "notes": "Pre-auth if > EGP 2,500"},
                    "CT Scan": {"covered": True, "limit": "Annual Limit", "notes": "Pre-auth if > EGP 2,500"},
                    "X-Ray": {"covered": True, "limit": "Annual Limit", "notes": ""},
                    "Blood Test": {"covered": True, "limit": "Annual Limit", "notes": ""},
                    "Ultrasound": {"covered": True, "limit": "Annual Limit", "notes": ""},
                    "Physiotherapy": {"covered": True, "limit": "Annual Limit", "notes": ""},
                    ...
                    "Dialysis": {"covered": True, "limit": "EGP 180,000", "notes": ""},
                    "Hearing Aids": {"covered": True, "limit": "EGP 6,000", "notes": ""},
                    "Kidney Transplant": {"covered": True, "limit": "EGP 250,000", "notes": "Pre-auth required"},
                    "Bone Marrow Transplant": {"covered": False, "limit": "Not Covered", "notes": ""},
                    "Obesity Surgery": {"covered": True, "limit": "EGP 20,000", "notes": "BMI > 35, pre-auth required"},
                    "ABA Therapy": {"covered": True, "limit": "EGP 50,000", "notes": "Per CHI regulations"},
                    "Cancer Treatment": {"covered": True, "limit": "Annual Limit", "notes": "Includes wig EGP 1,000"},
                    "Routine Checkup": {"covered": False, "limit": "Not Covered", "notes": ""},
                    "Screening": {"covered": True, "limit": "Annual Limit", "notes": ""},
    ...
    "GIG-ENT-2025": {
        "policy_number": "GIG-ENT-2025",
        "company_id": "GIG",
        "company_name": "GIG Egypt (Arab Misr Insurance Group)",
        "policy_holder": "Delta Technology Solutions",
        ...
        "classes": {
            "PLATINUM": {
                ...
                "inpatient": True,
                "outpatient": True,
                "outpatient_deductible": "10% up to EGP 30",
                "pre_auth_required": False,
                "pre_auth_limit": None,
                ...
                "covered_services": {
                    ...
                    "Blood Test": {"covered": True, "limit": "Annual Limit", "notes": ""},
                    "Ultrasound": {"covered": True, "limit": "Annual Limit", "notes": ""},
                    "Physiotherapy": {"covered": True, "limit": "EGP 80,000", "notes": ""},
                    "General Surgery": {"covered": True, "limit": "Annual Limit", "notes": ""},
                    "Laparoscopic Surgery": {"covered": True, "limit": "Annual Limit", "notes": ""},
                    "Maternity": {"covered": True, "limit": "EGP 50,000", "notes": ""},
                    "Dental (Corrective)": {"covered": True, "limit": "EGP 5,000", "notes": ""},
                    "Dental (Emergency)": {"covered": True, "limit": "EGP 3,000", "notes": ""},
                    "Dental (General)": {"covered": True, "limit": "EGP 2,000", "notes": "Annual"},
                    "Optical": {"covered": True, "limit": "EGP 3,000", "notes": ""},
                    "Vaccination": {"covered": True, "limit": "Annual Limit", "notes": ""},
                    "Psychiatric": {"covered": True, "limit": "EGP 75,000", "notes": ""},
                    "Dialysis": {"covered": True, "limit": "EGP 200,000", "notes": ""},
                    "Hearing Aids": {"covered": True, "limit": "EGP 8,000", "notes": ""},
                    "Kidney Transplant": {"covered": True, "limit": "EGP 300,000", "notes": ""},
                    "Bone Marrow Transplant": {"covered": True, "limit": "EGP 200,000", "notes": ""},
                    "Obesity Surgery": {"covered": True, "limit": "EGP 30,000", "notes": "BMI > 30"},
                    "ABA Therapy": {"covered": True, "limit": "EGP 60,000", "notes": ""},
                    "Cancer Treatment": {"covered": True, "limit": "Annual Limit", "notes": ""},
                    "Routine Checkup": {"covered": True, "limit": "EGP 2,000", "notes": "Annual"},
                    "Screening": {"covered": True, "limit": "Annual Limit", "notes": ""},
                    "Birth Control": {"covered": True, "limit": "EGP 2,000", "notes": ""},
                    "Circumcision": {"covered": True, "limit": "EGP 800", "notes": ""},
                    "Neonatal Care": {"covered": True, "limit": "Annual Limit", "notes": ""},
                },
                "special_instructions": "International coverage up to EGP 500,000. Second opinion service available. Wellness programs covered."
            },
            "GOLD": {
                "annual_limit": 750000,
                "accommodation": "Single Room",
                ...
                "pre_auth_required": True,
                "pre_auth_limit": 3000,
                "pre_auth_notes": "Pre-authorization required for services exceeding EGP 3,000.",
                "covered_services": {
                    "MRI Scan": {"covered": True, "limit": "Annual Limit", "notes": "Pre-auth if > EGP 3,000"},
                    "CT Scan": {"covered": True, "limit": "Annual Limit", "notes": "Pre-auth if > EGP 3,000"},
                    "X-Ray": {"covered": True, "limit": "Annual Limit", "notes": ""},
                    "Blood Test": {"covered": True, "limit": "Annual Limit", "notes": ""},
                    "Ultrasound": {"covered": True, "limit": "Annual Limit", "notes": ""},
                    "Physiotherapy": {"covered": True, "limit": "EGP 30,000", "notes": ""},
                    "General Surgery": {"covered": True, "limit": "Annual Limit", "notes": "Pre-auth required"},
                    "Laparoscopic Surgery": {"covered": True, "limit": "Annual Limit", "notes": "Pre-auth required"},
                    "Maternity": {"covered": True, "limit": "EGP 25,000", "notes": ""},
                    "Dental (Corrective)": {"covered": True, "limit": "EGP 2,500", "notes": ""},
                    "Dental (Emergency)": {"covered": True, "limit": "EGP 1,500", "notes": ""},
                    "Dental (General)": {"covered": False, "limit": "Not Covered", "notes": ""},
                    "Optical": {"covered": True, "limit": "EGP 1,500", "notes": ""},
                    "Vaccination": {"covered": True, "limit": "EGP 1,000", "notes": ""},
                    "Psychiatric": {"covered": True, "limit": "EGP 30,000", "notes": ""},
                    "Dialysis": {"covered": True, "limit": "EGP 120,000", "notes": ""},
                    "Hearing Aids": {"covered": True, "limit": "EGP 4,000", "notes": ""},
                    "Kidney Transplant": {"covered": True, "limit": "EGP 200,000", "notes": ""},
                    "Bone Marrow Transplant": {"covered": False, "limit": "Not Covered", "notes": ""},
                    "Obesity Surgery": {"covered": False, "limit": "Not Covered", "notes": ""},
                    "ABA Therapy": {"covered": True, "limit": "EGP 40,000", "notes": ""},
                    "Cancer Treatment": {"covered": True, "limit": "EGP 400,000", "notes": ""},
                    "Routine Checkup": {"covered": False, "limit": "Not Covered", "notes": ""},
                    "Screening": {"covered": True, "limit": "EGP 5,000", "notes": ""},
                    "Birth Control": {"covered": True, "limit": "EGP 1,000", "notes": ""},
                    "Circumcision": {"covered": True, "limit": "EGP 500", "notes": ""},
                    "Neonatal Care": {"covered": True, "limit": "EGP 50,000", "notes": ""},
                },
    ...
    "MISR-SME-2025": {
        ...
        "classes": {
            "B": {
                ...
                "inpatient": True,
                "outpatient": True,
                "outpatient_deductible": "20% up to EGP 60",
                "pre_auth_required": True,
                "pre_auth_limit": 1500,
                "pre_auth_notes": "Pre-authorization required for all services exceeding EGP 1,500 or any inpatient admission.",
                "covered_services": {
                    "MRI Scan": {"covered": True, "limit": "EGP 5,000/scan", "notes": "Pre-auth required"},
                    "CT Scan": {"covered": True, "limit": "EGP 3,000/scan", "notes": "Pre-auth required"},
                    "X-Ray": {"covered": True, "limit": "Annual Limit", "notes": ""},
                    "Blood Test": {"covered": True, "limit": "Annual Limit", "notes": ""},
                    "Ultrasound": {"covered": True, "limit": "Annual Limit", "notes": ""},
                    "Physiotherapy": {"covered": True, "limit": "EGP 10,000", "notes": "Max 20 sessions/year"},
                    "General Surgery": {"covered": True, "limit": "Annual Limit", "notes": "Pre-auth required"},
                    "Laparoscopic Surgery": {"covered": True, "limit": "Annual Limit", "notes": "Pre-auth required"},
                    "Maternity": {"covered": True, "limit": "EGP 15,000", "notes": "Normal delivery only"},
                    "Dental (Corrective)": {"covered": False, "limit": "Not Covered", "notes": ""},
                    "Dental (Emergency)": {"covered": True, "limit": "EGP 1,000", "notes": ""},
                    "Dental (General)": {"covered": False, "limit": "Not Covered", "notes": ""},
                    "Optical": {"covered": True, "limit": "EGP 800", "notes": "Every 2 years"},
                    "Vaccination": {"covered": True, "limit": "EGP 500", "notes": "Children only"},
                    "Psychiatric": {"covered": True, "limit": "EGP 15,000", "notes": ""},
                    "Dialysis": {"covered": True, "limit": "EGP 80,000", "notes": ""},
                    "Hearing Aids": {"covered": False, "limit": "Not Covered", "notes": ""},
                    "Kidney Transplant": {"covered": True, "limit": "EGP 150,000", "notes": "Pre-auth required"},
                    "Bone Marrow Transplant": {"covered": False, "limit": "Not Covered", "notes": ""},
                    "Obesity Surgery": {"covered": False, "limit": "Not Covered", "notes": ""},
                    "ABA Therapy": {"covered": False, "limit": "Not Covered", "notes": ""},
                    "Cancer Treatment": {"covered": True, "limit": "EGP 200,000", "notes": "Pre-auth required"},
                    "Routine Checkup": {"covered": False, "limit": "Not Covered", "notes": ""},
                    "Screening": {"covered": False, "limit": "Not Covered", "notes": ""},
                    "Birth Control": {"covered": False, "limit": "Not Covered", "notes": ""},
                    "Circumcision": {"covered": True, "limit": "EGP 300", "notes": ""},
                    "Neonatal Care": {"covered": True, "limit": "EGP 30,000", "notes": ""},
                },
            ...
            "C": {
                ...
                "inpatient": True,
                "outpatient": False,
                "outpatient_deductible": "30% up to EGP 100",
                "pre_auth_required": True,
                "pre_auth_limit": 500,
                "pre_auth_notes": "Pre-authorization required for ALL services. Outpatient not covered under this class.",
                "covered_services": {
                    "MRI Scan": {"covered": True, "limit": "EGP 2,000", "notes": "Inpatient only, pre-auth required"},
                    "CT Scan": {"covered": True, "limit": "EGP 1,500", "notes": "Inpatient only"},
                    "X-Ray": {"covered": True, "limit": "EGP 500", "notes": ""},
                    "Blood Test": {"covered": True, "limit": "EGP 200", "notes": ""},
                    "Ultrasound": {"covered": True, "limit": "EGP 500", "notes": ""},
                    ...
                    "Dialysis": {"covered": True, "limit": "EGP 30,000", "notes": ""},
                    "Hearing Aids": {"covered": False, "limit": "Not Covered", "notes": ""},
                    "Kidney Transplant": {"covered": False, "limit": "Not Covered", "notes": ""},
                    "Bone Marrow Transplant": {"covered": False, "limit": "Not Covered", "notes": ""},
                    "Obesity Surgery": {"covered": False, "limit": "Not Covered", "notes": ""},
                    "ABA Therapy": {"covered": False, "limit": "Not Covered", "notes": ""},
                    "Cancer Treatment": {"covered": True, "limit": "EGP 50,000", "notes": "Inpatient only"},
                    "Routine Checkup": {"covered": False, "limit": "Not Covered", "notes": ""},
                    "Screening": {"covered": False, "limit": "Not Covered", "notes": ""},
                    "Birth Control": {"covered": False, "limit": "Not Covered", "notes": ""},
                ...
                "special_instructions": "Emergency inpatient admissions only. All non-emergency services require prior approval from Misr Insurance medical team."
            }
        }
    }
}
...
PATIENTS = {
    ...
    "P1003": {
        "id": "P1003",
        "name": "Khaled Ibrahim El-Rashidi",
        "dob": "1978-11-02",
        "gender": "Male",
        "nationality": "Egyptian",
        "policy_number": "502277005",
    ...
    "P1007": {
        "id": "P1007",
        "name": "Youssef Tariq El-Ghamrawy",
        "dob": "2010-04-03",
        "gender": "Male",
        "nationality": "Egyptian",
        "policy_number": "502277005",
